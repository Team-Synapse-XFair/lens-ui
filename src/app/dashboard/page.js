    ...
    return (
        <div className="flex items-center justify-center bg-background px-4" style={{ height: "calc(100vh - var(--header-height))" }}>
            <div className="max-w-4xl w-full bg-transparent border-none">
                <h1 className="text-3xl font-bold mb-4 text-center">Welcome to your Dashboard, {username}!</h1>
                <p className="text-lg text-center mb-8">Manage your reports and view your activity here.</p>
                {/*
